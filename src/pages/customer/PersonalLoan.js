...
const PersonalLoan = () => {
  ...
  const documentConfig = getLoanDocumentConfig('PERSONAL_LOAN');
        ...
        <div className="row">
          <div className="col-md-2" style={{ backgroundColor: '#F8F9FA', minHeight: 'calc(100vh - 56px)', borderRight: '1px solid #dee2e6', padding: '20px 0' }}>
            <div className="nav flex-column">
              ...
              <a className="nav-link active" href="/customer/apply/personal" style={{ color: '#333333', fontWeight: 'bold', backgroundColor: '#e9ecef' }}>Apply Personal Loan</a>
          ...
          <div className="col-md-10" style={{ padding: '30px' }}>
            <h2 style={{ color: '#333333', marginBottom: '30px' }}>Apply for Personal Loan</h2>
                ...
                <div className="row">
                  ...
                  <div className="col-md-12 mb-3">
                    <label style={{ color: '#333333', display: 'block', marginBottom: '5px' }}>
                      Salary Slip <span style={{ color: '#dc3545' }}>*</span>
                    </label>
                    <input
                      type="file"
                      className="form-control"
